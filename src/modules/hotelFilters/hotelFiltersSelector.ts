...
export const selectChildrenFilter = (state: RootState) => state.hotelFilters.children;
export const selectAdultsFilter = (state: RootState) => state.hotelFilters.adults;
